...
class CrPayrollDisabilityRule(models.Model):
    ...
    code = fields.Selection(
        [
            ...
            ("SOA", "Accidente de tránsito / SOA"),
            ("ADOPTION", "Licencia por adopción"),
            ("MATERNAL_DEATH", "Licencia especial posparto por muerte materna"),
            ("CARE_TERMINAL", "Cuido de paciente en fase terminal"),
            ("CARE_MINOR_SEVERE", "Cuido de menor gravemente enfermo"),
            ("CARE_EXTRAORDINARY", "Licencia extraordinaria de cuido"),
],
